...
Pega `firebase-rules-v1.3.4.json` y publica.
...
- Requiere publicar las reglas `firebase-rules-v1.3.4.json` porque se añade el campo opcional `geoStatus`.
...
La v1.3.4 elimina esa dependencia:
